...
import no.ntnu.server.repo.QuizOptionRepo;
import no.ntnu.server.repo.QuizQuestionRepo;
import no.ntnu.server.repo.QuizRepo;
import no.ntnu.server.repo.QuizSessionRepo;
import no.ntnu.server.repo.UserRepo;
import no.ntnu.server.tables.Quiz;
import no.ntnu.server.tables.QuizAnswer;
...
import no.ntnu.server.tables.QuizSessionTable;
